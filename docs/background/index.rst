...
Luckaly CircuitPython has some built in libraries that will make this much easier for us. We will be using 2, :file:`ugame` and :file:`stage`. We will import these 2 libraries at the top of our code and then we will write the following code to fill the background with the zeroith image:
